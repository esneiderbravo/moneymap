...
import { AccountsOptionsContainer } from "../../../styles/more/manage/ManageAccountsContent.styled";
 ...
 */
const ManageAccountsContent = ({ isOpen, setSelectedOption }) => {
  ...
  const formattedDate = `${lastDay.getDate()}/${lastDay
  ...
  return (
    <Drawer open={isOpen} onClose={handleClose} anchor="right" disableAutoFocus>
      {/* Common Header */}
 ...
 */
ManageAccountsContent.propTypes = {
